...
<body class="wrapper">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-1">
                <button type="button" class="btn" style="background-color: #023062;"> <a
                        style="color: white; text-decoration:none;" href="profil.php">Retour au profil</a></button>
            </div>
            <div class="col-md-8">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-4 p-4">
                            <form method="post" action="../controllers/controller_modif.php?func=modifMDP">
                    ...
                    <div class="row" style="text-align: center;">
                        <div class="col-4 p-4"></div>
                        <div class="col-4 p-4">
                            <button type="submit" class="btn" style="background-color: #023062;"> <a
                                    style="color: white; text-decoration:none;">Changer le mot de
                                    passe</a></button>
                        </div>
                        <div class="col-4 p-4"></div>
                    </div>
