        ...
        <div class="row justify-content-center" id="menu1" display="none">
            <div class="col-md-8">
                ...
                <p>Cependant, ce principe comporte certaines exceptions. En effet, pour certains services proposés par
                    ...
                    votre prénom, votre adresse email, votre numéro de téléphone et votre adresse postale. Tel est le
                    cas lorsque vous
                    remplissez le formulaire qui vous est proposé en ligne pour réserver une place sur un trajet ou
                    proposer un trajet.</p>

                <p>Dans tous les cas, vous pouvez refuser de fournir vos données personnelles. Dans ce cas, vous ne
                    pourrez pas utiliser ces fonctionnalités.</p>
