...
<head>
    ...
    <link href="../assets/css/mestrajets.css" rel="stylesheet" />
...
<body class="wrapper" id="body">
    ...
    <!--Pour afficher les trajets dont on est conducteur-->
    <h1 id="title">Mes trajets :</h1>
    <div class="container" id="mestrajets">

    <!--Pour afficher les trajets dont on est passager-->
    </div>
    <h1 id="title"> Trajets que j'ai rejoints : </h1>
    <div class="container" id="join_trajet">
...
<script src="../js/mestrajets.js"></script>
